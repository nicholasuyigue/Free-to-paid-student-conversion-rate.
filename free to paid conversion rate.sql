...
-- The above query yields a temporary result table showing: student_id, date_registered, first_date_watched,
 -- first_date_purchased, days_diff_reg_watch (difference in days between first engagement and registration),
 -- days_diff_watch_purch (difference in days between first engagement and purchase)
-- Now, Insert above query as a subquery into the below main query:
